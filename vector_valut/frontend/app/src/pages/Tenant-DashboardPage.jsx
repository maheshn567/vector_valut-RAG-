    ...
    <div className="min-h-screen bg-[#051424] text-[#d4e4fa] font-['Inter'] relative overflow-x-hidden selection:bg-[#6c5ce7]/30">
      ...
      <aside className="fixed left-0 top-0 h-full w-64 bg-[#0d1c2d] border-r border-white/5 flex flex-col py-6 px-4 gap-4 z-40 shadow-xl">
        ...
        <button 
          ...
          className="w-full py-2.5 px-4 bg-[#6c5ce7] hover:bg-[#5847d2] text-white font-bold rounded-lg flex items-center justify-center gap-2 hover:opacity-90 active:scale-95 transition-all mb-4 cursor-pointer text-sm"
        >
        ...
        <nav className="flex-1 space-y-1 text-left">
          <Link to="/dashboard" className="bg-[#6c5ce7]/10 text-[#c6bfff] font-bold rounded-lg flex items-center gap-3 py-2.5 px-4 transition-all">
            <span className="material-symbols-outlined text-base">dashboard</span>
            <span className="font-['JetBrains_Mono'] text-[11px] uppercase tracking-wider">Dashboard</span>
          </Link>
          
          <Link to="/apps" className="flex items-center gap-3 py-2.5 px-4 text-[#c8c4d7] hover:bg-white/5 hover:text-white transition-all rounded-lg">
            <span className="material-symbols-outlined text-base">apps</span>
            <span className="font-['JetBrains_Mono'] text-[11px] uppercase tracking-wider">Apps</span>
          </Link>

          <Link to="/corpora" className="flex items-center gap-3 py-2.5 px-4 text-[#c8c4d7] hover:bg-white/5 hover:text-white transition-all rounded-lg">
            <span className="material-symbols-outlined text-base">database</span>
            <span className="font-['JetBrains_Mono'] text-[11px] uppercase tracking-wider">Corpora / Groups</span>
          </Link>

          <Link to="/documents" className="flex items-center gap-3 py-2.5 px-4 text-[#c8c4d7] hover:bg-white/5 hover:text-white transition-all rounded-lg">
            <span className="material-symbols-outlined text-base">description</span>
            <span className="font-['JetBrains_Mono'] text-[11px] uppercase tracking-wider">Documents</span>
          </Link>

          <Link to="/conversations" className="flex items-center gap-3 py-2.5 px-4 text-[#c8c4d7] hover:bg-white/5 hover:text-white transition-all rounded-lg">
            <span className="material-symbols-outlined text-base">forum</span>
            <span className="font-['JetBrains_Mono'] text-[11px] uppercase tracking-wider">Conversations</span>
          </Link>

          <Link to="/keys" className="flex items-center gap-3 py-2.5 px-4 text-[#c8c4d7] hover:bg-white/5 hover:text-white transition-all rounded-lg">
            <span className="material-symbols-outlined text-base">vpn_key</span>
            <span className="font-['JetBrains_Mono'] text-[11px] uppercase tracking-wider">API Keys</span>
          </Link>

          <Link to="/settings" className="flex items-center gap-3 py-2.5 px-4 text-[#c8c4d7] hover:bg-white/5 hover:text-white transition-all rounded-lg">
        ...
        <div className="pt-4 border-t border-white/5 space-y-1 text-left">
          ...
          <button 
            onClick={logout}
            className="w-full flex items-center gap-3 py-2 px-4 text-[#ffb4ab] hover:bg-[#ffb4ab]/10 transition-colors rounded-lg text-sm cursor-pointer text-left"
          >
            <span className="material-symbols-outlined text-base">logout</span>
            <span className="font-['JetBrains_Mono'] text-[11px] uppercase tracking-wider font-semibold">Sign Out</span>
          </button>
        </div>
