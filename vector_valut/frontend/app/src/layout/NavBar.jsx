  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-4 bg-[#051424]/80 backdrop-blur-md border-b border-white/5 shadow-lg shadow-black/20">
      ...
      <div className="flex items-center gap-5 font-['Inter']">
        ...
        <Link to="/signup" className="text-sm font-semibold text-white bg-[#6C5CE7] hover:bg-[#5847d2] px-4 py-2 rounded-lg transition-all duration-200 border border-white/10 shadow-lg shadow-[#6C5CE7]/20 hover:shadow-[#6C5CE7]/30 transform hover:-translate-y-[1px]">
          Get Started Free
        </Link>
      </div>
    </nav>
